...
class GeneticAlgorithm:
    ...
    def evolve(self, game, a_star_path):
        ...
        fitness_scores = [self.evaluate_fitness(game, chromosome, a_star_path, [(enemy.tile_x, enemy.tile_y) for enemy in game.enemies]) for chromosome in self.population]
